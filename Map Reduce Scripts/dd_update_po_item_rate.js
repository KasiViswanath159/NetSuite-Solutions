...
function(runtime, file, record, search, task, format, email) {
    ...
    function map(context) {
        ...
        var poVal = JSON.parse(context.value);
    ...
    function reduce(context) {
        ...
        var poNum = context.key;
        log.debug('poNum', poNum);
        var recordId = getPoId(poNum);
      ...
      for (var y = 0; y < values.length; y++) {
        ...
        var line = JSON.parse(values[y]);
        var itemId =  getitemId(line.lineId);
